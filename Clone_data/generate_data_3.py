...
openai.api_key = "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"
...
# example 2
with open("dataset/in-context-examples/in-context-example-5.txt", "r") as f:
    contex = f.read()
...
final_save = "dataset/openai-api-train-生成数据-5/code_contest.json"

for run_time in range(100):
    try:
        with open("output_solution-5.json", "w") as f_out:
        ...
        # read output file 
        with open("output_solution-5.json", "r") as f:
