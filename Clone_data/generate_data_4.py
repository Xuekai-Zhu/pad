...
# openai.api_key = "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"
# openai.api_key = "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"
openai.api_key = "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"
...
# example 2
with open("dataset/in-context-examples/in-context-example-6.txt", "r") as f:
    contex = f.read()
...
final_save = "dataset/openai-api-train-生成数据-6/code_contest.json"
run_time_file = "output_solution-6.json"
