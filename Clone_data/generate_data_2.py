...
# example 2
with open("dataset/in-context-examples/in-context-example-4.txt", "r") as f:
    contex = f.read()
...
final_save = "dataset/opan-ai-api-train-生成数据-4/code_contest.json"

for run_time in range(100):
    try:
        with open("output_solution-4.json", "w") as f_out:
        ...
        # read output file 
        with open("output_solution-4.json", "r") as f:
